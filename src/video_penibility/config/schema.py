...
class DataConfig:
    ...
    features_type: Literal[
        "facenet", "resnet", "facemesh", "facemesh_dist_v1", "facemesh_dist_v2",
        "i3d", "swin3d_t", "swin3d_s", "swin3d_b", "libreface"
    ] = "i3d"
...
class MainConfig:
    ...
    def validate(self) -> None:
        ...
        if not Path(self.data.annotation_path).exists():
            raise FileNotFoundError(f"Annotation file not found: {self.data.annotation_path}")
