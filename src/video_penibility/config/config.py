...
class Config:
    ...
    def load_from_dict(self, config_dict: Dict[str, Any]) -> None:
        ...
        if 'cross_validation' in config_dict:
            self._update_dataclass(self._config.cross_validation, config_dict['cross_validation'])
        
        if 'visualization' in config_dict:
            self._update_dataclass(self._config.visualization, config_dict['visualization'])
