...
class TrainerFactory:
    ...
    def create_optimizer(
        cls, model: nn.Module, training_config: TrainingConfig
        ...
        logger.info(
            f"Created {optimizer_name} optimizer with lr={training_config.learning_rate}"
        )
    ...
    def create_scheduler(
        ...
        logger.info(
            f"Created {scheduler_name} scheduler with params: {scheduler_params}"
        )
